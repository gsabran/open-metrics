...
/*
 * clientUser: a user on the product, identified by a cookie
 * {uid: an id that identifies the user accross sessions, props: {name: value}* }
 */
export const ClientUsers = new Mongo.Collection('clientusers');

/*
 * clientSession: a session, identified by a cookie
 * {_id: sessionId, uid: the uid of the corresponding user, props: {name: value}* }
 */
export const ClientSessions = new Mongo.Collection('clientsessions');
